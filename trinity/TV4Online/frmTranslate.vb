...
Public Class frmTranslate
    ...
    Private Sub frmTranslate_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        For Each _row As System.Windows.Forms.DataGridViewRow In grdTranslate.Rows
            TV4OnlinePlugin.InternalApplication.SetUserPreference("TV4Spotlight", _row.Cells(0).Value, _row.Cells(1).Value)
        Next
    End Sub

    Public Sub New(TrinityValues As List(Of String), SpotlightValues As List(Of String))
        ...
        _spotlightValues = SpotlightValues

        With DirectCast(colSpotlight, DataGridViewComboBoxColumn)
            .Items.AddRange(_spotlightValues.ToArray)
        End With

        grdTranslate.Rows.Add(_trinityValues.Count)
    ...
    Private Sub grdTranslate_CellValueNeeded(sender As Object, e As System.Windows.Forms.DataGridViewCellValueEventArgs) Handles grdTranslate.CellValueNeeded
        Select Case e.ColumnIndex
            Case colTrinity.Index
                e.Value = _trinityValues(e.RowIndex)
    ...
    Private Sub grdTranslate_CellValuePushed(sender As Object, e As System.Windows.Forms.DataGridViewCellValueEventArgs) Handles grdTranslate.CellValuePushed
        If e.ColumnIndex = colSpotlight.Index Then
