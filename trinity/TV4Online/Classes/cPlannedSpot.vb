...
Namespace TrinityExtended
    Public Class cPlannedSpot
        ...
        Private mvarChannel As Object 'the channel where the spot is beeing aired
        ...
        Private mvarWeek As Object 'the week where the spot is located
        Private mvarBookingtype As Object 'the booking type used
        ...
        Private mvarAddedValue As Object
        'Private Main As cKampanj 'the main campaign
        Private mvarEstimation As Double
...
Filmcode_Error:
        ...
        Public Property AddedValue() As Object
            Get
        ...
        Public Property Week() As Object
            '---------------------------------------------------------------------------------------
            ' Procedure : Week
...
Product_Error:
        ...
        Public ReadOnly Property Film() As Object
            '---------------------------------------------------------------------------------------
            ' Procedure : Film
            ' DateTime  : 2003-07-18 09:50
            ' Author    : joho
...
Rating_Error:
        ...
        Public Property Estimation() As Double
            '---------------------------------------------------------------------------------------
