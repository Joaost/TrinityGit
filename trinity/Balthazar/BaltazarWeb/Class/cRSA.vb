Public Class cRSA
    Public key(0 To 3) As Long
    Private Const base64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"

    Public Sub GenKey(ByVal e As Long, ByVal d As Long, ByVal n As Long, ByVal Seed As Long)
        Dim phi As Long
...
error1:
    ...
    Private Function IsPrime(ByVal lngNumber As Long) As Boolean
        ...
        lngSqr = Math.Sqrt(lngNumber) ' get the int square root
    ...
    Private Function base64_encode(ByVal DecryptedText As String) As String
    ...
    Private Function base64_decode(ByVal a As String) As String
        Dim w1 As Integer
        Dim w2 As Integer
        Dim w3 As Integer
        Dim w4 As Integer
    ...
    Public Function Decode(ByVal inp As String, ByVal d As Long, ByVal n As Long) As String
        ...
        Dim St As String = ""
        Dim ind As String = base64_decode(inp)
        For i As Integer = 1 To Len(ind)
            Dim nxt As Integer = InStr(i, ind, "+")
            Dim tok As Integer
            If Not nxt = 0 Then
