...
Namespace Trinity
    ...
    Public Class cColorSchemes
        ...
        Public Function ReadColorSchemes() As Boolean
            ...
            If Not System.IO.File.Exists(TrinitySettings.ActiveDataPath & "colorschemes.xml") Then Return False

            Dim xmlSchemes As New Xml.XmlDocument

            xmlSchemes.Load(TrinitySettings.ActiveDataPath & "colorschemes.xml")
        ...
        Public Function SaveColorSchemes() As Boolean
            ...
            For Each scheme As cColorScheme In mCol
                ...
                attributes("text").Value = toXML(scheme.PanelFGColor)
            ...
            xmlSchemes.Save(TrinitySettings.ActiveDataPath & "colorschemes.xml")
        ...
        Private Function fromXML(ByVal XML As String) As Color
            ...
            Dim B As Integer = System.Convert.ToInt32(XML.Substring(5, 2), 16)
