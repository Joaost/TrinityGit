...
Public Module Declarations
    ...
    Public GeneralFilter As Trinity.cFilter
    Public campaign As Trinity.cKampanj
...
#Region "Dummy Classes in order for Helper class to be useable"
    Public Class frmFilmNotFound
        Inherits Form

        Public ReadOnly Property optSetAsOld() As RadioButton
            Get
                Return New RadioButton
            End Get
        End Property

        Public ReadOnly Property optChangeOnSpots() As RadioButton
            Get
                Return New RadioButton
            End Get
        End Property

        Public ReadOnly Property cmbFilm() As ComboBox
            Get
                Return New ComboBox
            End Get
        End Property

        Public Sub New(ByVal Dummy1 As String, ByVal Dummy2 As String, ByVal Dummy3 As String, ByVal Dummy4 As String)
...
#End Region
    ...
    Public Class frmActualSpotFilmNotFound
        ...
        Public Sub New(ByVal Dummy1 As String, ByVal Dummy2 As String, ByVal Dummy3 As String)
