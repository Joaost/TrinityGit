    ...
    Public Class cSearch
        ...
        Public Overrides Function ToString() As String
            ...
            Select Case _RuleType
                ...
                Case RuleTypeEnum.Constant
                    Return "Set value to '" & SearchValue & "'"
                Case Else
                    Return ""
            End Select
        End Function
        ...
        Public Sub New(Rule As cRule, Template As ITemplate, Optional ParentSearch As cSearch = Nothing)
            Me.Rule = Rule
        ...
        Function GetXML() As XElement
            ...
            Select Case RuleType
                ...
                Case RuleTypeEnum.Constant
                    _node = <constant value=<%= SearchValue %>></constant>
            End Select
            Return _node
        End Function
        ...
        Sub Parse(xml As XElement)
            ...
            Select Case xml.Name
                ...
                Case "step"
                    ...
                    Row = xml.@row
                Case "constant"
                    RuleType = RuleTypeEnum.Constant
            ...
            ElseIf xml.Attribute("value") IsNot Nothing Then
                SearchType = Nothing
                SearchValue = xml.Attribute("value").Value
            End If
        End Sub

        Function Execute(Schedule As cDocument, Optional PreviousSearchResult As cSearchResult = Nothing) As cSearchResult
                ...
                Select Case _RuleType
                    ...
                    Case RuleTypeEnum.Find
                        ...
                        If PreviousSearchResult IsNot Nothing Then
                            ...
                            End If
                        End If
                        For _r As Integer = IIf(_row < 1, 1, _row) To IIf(_toRow < 1, 1, _toRow) Step IIf(_toRow < _row, -1, 1)
        ...
        Private Function GetResultForCell(Schedule As cDocument, Sheet As cTemplateSheet, Row As Integer, Column As Integer) As cSearchResult
            ...
            Select Case SearchType
                Case SearchTypeEnum.ValueIs
                    If Sheet.Cells(Row, Column).ToString.ToUpper = SearchValue.ToUpper Then
                        _result.Row = Row
                    ...
                    End If
                Case SearchTypeEnum.ValueIsNot
                    If Not Sheet.Cells(Row, Column).ToString.ToUpper = SearchValue.ToUpper Then
                        _result.Row = Row
                        _result.Column = Column
                        _result.Succeeded = True
                        _result.Result = Sheet.Cells(Row, Column)
                ...
                Case SearchTypeEnum.Contains
                    If Sheet.Cells(Row, Column).ToString.ToUpper.Contains(SearchValue.ToUpper) Then
                        _result.Row = Row
                        _result.Column = Column
                        _result.Succeeded = True
                        _result.Result = Sheet.Cells(Row, Column)
                    ...
                    End If
                Case SearchTypeEnum.ContainsNot
                    If Not Sheet.Cells(Row, Column).ToString.ToUpper.Contains(SearchValue.ToUpper) Then
                        _result.Row = Row
                        _result.Column = Column
                        _result.Succeeded = True
                        _result.Result = Sheet.Cells(Row, Column)
        ...
        Function Clone(Rule As cRule, Template As ITemplate, Optional ParentSearch As cSearch = Nothing) As cSearch
