Imports clTrinity.ExcelReadTemplates
...
Namespace ExcelReadTemplates
    Public Class cDocument
        ...
        Private _sheets As New Dictionary(Of String, cTemplateSheet)
        Public ReadOnly Property Sheets As Dictionary(Of String, cTemplateSheet)
            Get
                Return _sheets
            End Get
        End Property
        ...
        Public Sub Load(Filename As String)
            ...
            For _s As Integer = 1 To WB.SheetCount
                ...
                If _sheet.UsedRange.Columns.Count > 1 AndAlso _sheet.UsedRange.Rows.Count > 1 Then
                    _sheets.Add(_sheet.Name, New cTemplateSheet(_sheet))
                End If
            Next
        End Sub

        Function ReadSheet(Sheet As Microsoft.Office.Interop.Excel.Worksheet) As cTemplateSheet
            Dim _sheet As New cTemplateSheet(Sheet.UsedRange.Rows.Count + Sheet.UsedRange.Row - 1, Sheet.UsedRange.Columns.Count + Sheet.UsedRange.Column - 1)
